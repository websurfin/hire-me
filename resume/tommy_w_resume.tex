...
% main resume content created by Tommy White based on AltaCV v1.1.3 template found on Overleaf
\documentclass[11pt]{resume}

\geometry{                      % NOTE: `marginparwidth + marginparsep` should equal `right - left`
    left=1.25cm,                % offset of left column start from left side
    right=9.5cm,                % offset of right column end from right side 
    marginparwidth=7.75cm,      % offset of right column start from right side
    marginparsep=0.5cm,         % margin between columns
...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Managed datasets with terabytes of data as well as the thousands of computation jobs 
            used to process and analyze this data.
    \end{itemize}
